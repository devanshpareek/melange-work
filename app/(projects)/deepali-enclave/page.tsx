...
const projectDetails = {
  ...
  testimonial: {
    quote:
      "While exploring multiple brands and managing several projects, we came across Melange—and a few things immediately stood out. Firstly, the quality, and secondly, the responsiveness. Their attention to detail, speed of execution, and responsiveness to every doubt no matter how many times you ask. They walk with you through every step, helping you select the best options for every corner of the house. There were moments that truly made me realize that choosing Melange was the right decision. Initially, we had finalized wooden flooring for the lounge, but at the very last moment, I became unsure. I called Sangeeta ji and suggested changing it. Within one to two hours, she was ready with an alternate design. Our project was completed from scratch within 12 months, and without Melange, we are sure this would not have been possible.",
    author: "Pooja & Arun Gupta",
    role: "Homeowners",
